    ...
    (function(root, factory) {
      ...
      var PROCEDURE_CALL_COMMON$$module$build$src$blocks$procedures = { getProcedureCall: function() {
        ...
        for (var a = 0; a < this.arguments_.length; a++) {
          ...
          } else b = $.fromJson$$module$build$src$core$field_registry({ type: "field_label", text: this.arguments_[a] }), this.appendValueInput("ARG" + a).setAlign($.Align$$module$build$src$core$inputs$input.RIGHT).appendField(
            b,
            "ARGNAME" + a
          ).init();
        }
      ...
      var LISTS_GETINDEX$$module$build$src$blocks$lists = {
        init: function() {
          ...
          this.setTooltip(() => {
            ...
            if ("FROM_START" === c || "FROM_END" === c) d += "  " + ("FROM_START" === c ? $.Msg$$module$build$src$core$msg.LISTS_INDEX_FROM_START_TOOLTIP : $.Msg$$module$build$src$core$msg.LISTS_INDEX_FROM_END_TOOLTIP).replace("%1", this.workspace.options.oneBasedIndex ? "#1" : "#0");
            return d;
          });
        },
        mutationToDom: function() {
